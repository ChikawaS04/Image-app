    ...
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var staff = await _context.Staffs
                .Include(p => p.StaffPhoto) //I added this too 
        ...
        public async Task<IActionResult> Create([Bind("StaffID,StaffTitle,StaffFirstName,StaffLastname," +
            "StaffPhone,StaffEmail")] Staff staff, IFormFile pictureFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffID,StaffTitle,StaffFirstName," +
            "StaffLastname,StaffPhone,StaffEmail")] Staff staff, string chkRemoveImage, IFormFile pictureFile)
        {
            if (id != staff.StaffID)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    // Attach the updated staff entity to the context, marking it as modified to ensure it gets updated

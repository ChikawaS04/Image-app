	...
	public class ProjectsController : Controller
    {
		...
		public async Task<IActionResult> Details(int? id)
        {
            ...
            var project = await _context.Projects
                ...
                .Include(p => p.Location)
                .Include(p => p.Status)
                .Include(p => p.ProjectPhoto) //I added this too 
        ...
        public async Task<IActionResult> Create([Bind("ProjectId,ProjectName,ProjectDescription,ProjectLocation,ProjectStartDate,ProjectEndDate," +
            "ClientId,LocationId,StatusID")] Project project, IFormFile pictureFile)
        {
            if (ModelState.IsValid)
            {
                //add picture before saving
           ...
           // ViewData["LocationId"] = new SelectList(_context.Locations, "LocationId", "LocationName", project.LocationId);
            ViewData["StatusID"] = new SelectList(_context.Statuss, "StatusID", "StatusName", project.StatusID);
            return View(project);
        }
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjectId,ProjectName,ProjectDescription,ProjectLocation,ProjectStartDate," +
            "ProjectEndDate,ClientId,LocationId,StatusID")] Project project, string chkRemoveImage, IFormFile pictureFile)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    // This marks the entity as modified and sets it to be updated in the database
        ...
        //method to get picture, and save it

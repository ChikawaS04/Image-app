...
namespace NBD3.Data
{
    public class NBDContext : DbContext
    {
        ...
        public DbSet<ProjectPhoto> ProjectPhotos { get; set; } // added this 
        public DbSet<ProjectThumbnail> ProjectThumbnails { get; set; } // added this 
        public DbSet<StaffPhoto> StaffPhotos { get; set; } // added this 
        public DbSet<StaffThumbnail> StaffThumbnails { get; set; } // added this

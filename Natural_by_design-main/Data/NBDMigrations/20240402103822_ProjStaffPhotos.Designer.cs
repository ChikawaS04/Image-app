...
namespace NBD3.Data.NBDMigrations
{
    ...
    [Migration("20240402103822_ProjStaffPhotos")]
    partial class ProjStaffPhotos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBD3.Models.Project", b =>
                {
                    ...
                    b.HasOne("NBD3.Models.Status", "Status")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("NBD3.Models.StaffPhoto", b =>
                {
                    b.HasOne("NBD3.Models.Staff", "Staff")
                        .WithOne("StaffPhoto")
                        .HasForeignKey("NBD3.Models.StaffPhoto", "StaffID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NBD3.Models.StaffThumbnail", b =>
                {
                    b.HasOne("NBD3.Models.Staff", "Staff")
                        .WithOne("StaffThumbnail")
                        .HasForeignKey("NBD3.Models.StaffThumbnail", "StaffID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NBD3.Models.Staff", b =>
                {
                    ...
                    b.Navigation("StaffPhoto");

                    b.Navigation("StaffThumbnail");
                });
